...
static const _Counter_type_support_symbol_names_t _Counter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, encoders_interfaces, msg, Counter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, encoders_interfaces, msg, Counter)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, encoders_interfaces, msg, Counter)() {
  return &::encoders_interfaces::msg::rosidl_typesupport_c::Counter_message_type_support_handle;
}
