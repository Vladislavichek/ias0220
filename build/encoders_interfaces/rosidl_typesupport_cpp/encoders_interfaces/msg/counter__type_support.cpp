...
static const _Counter_type_support_symbol_names_t _Counter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, encoders_interfaces, msg, Counter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, encoders_interfaces, msg, Counter)),
  }
};
...
{
  return &::encoders_interfaces::msg::rosidl_typesupport_cpp::Counter_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, encoders_interfaces, msg, Counter)() {
  return get_message_type_support_handle<encoders_interfaces::msg::Counter>();
}
