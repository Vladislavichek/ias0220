...
#include "encoders_interfaces/msg/detail/counter__rosidl_typesupport_fastrtps_c.h"
...
#include "encoders_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Counter__ros_msg_type = encoders_interfaces__msg__Counter;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: count_left
  {
    cdr << ros_message->count_left;
  }

  // Field name: count_right
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Counter__ros_msg_type * ros_message = static_cast<_Counter__ros_msg_type *>(untyped_ros_message);
  // Field name: count_left
  {
    cdr >> ros_message->count_left;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_encoders_interfaces
size_t get_serialized_size_encoders_interfaces__msg__Counter(
  const void * untyped_ros_message,
...
static uint32_t _Counter__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_encoders_interfaces__msg__Counter(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_encoders_interfaces
size_t max_serialized_size_encoders_interfaces__msg__Counter(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = encoders_interfaces__msg__Counter;
    is_plain =
      (
...
static size_t _Counter__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_encoders_interfaces__msg__Counter(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, encoders_interfaces, msg, Counter)() {
